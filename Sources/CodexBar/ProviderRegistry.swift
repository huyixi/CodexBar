...
struct ProviderRegistry {
        ...
        codexActiveSourceOverride: CodexActiveSource? = nil) -> [String: String]
    {
        ...
        let codexSource = codexActiveSourceOverride ?? settings.codexResolvedActiveSource
        if provider == .codex,
           case .managedAccount = codexSource,
           let managedHomePath = settings.managedCodexRemoteHomePath(for: codexSource)
        {
